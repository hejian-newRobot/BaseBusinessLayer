...
public class DataSourceConfigForHisUser {
	...
	public SqlSessionFactory fsAppByCateringSqlSessionFactory(@Qualifier("hisDB") DataSource dataSource) throws Exception {
	...
	public DataSourceTransactionManager fsAppByCateringTransactionManager(@Qualifier("hisDB") DataSource dataSource) {
